...
```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE}
selectizeInput('term', '', choices = c("Select" = "", c("202040", "202120")))
```
...
### Demographics
```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE}
data_01 <- if(nrow(error_check_01) > 0) {
...
### Degrees & Programs
```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE, fig.align='left'}
#source(here::here('rscript', 'programs.R'))
mkd_table(programs_check_01, "HS Student but no ND* Program", "Test")
br()
```

```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE, fig.align='left'}
mkd_table(programs_check_02, "Blank / Missing Programs", "Test")
```

### Student Type
```{r, message = FALSE, warning=FALSE, error = FALSE, echo = FALSE}
mkd_table(stype_check_01, "Returning Students", "Subtitle")
mkd_table(stype_check_02, "HS Concurrent Student", "Subtitle")
mkd_table(stype_check_03, "HS Concurrent Student", "Subtitle")
